...
public class CarouselViewPager extends ViewPager {
    ...
    private boolean animationAlreadyStarted = false;
    ...
    public void startAnimationOnce(boolean arrived, Animation.AnimationListener listener) {
        if (!animationAlreadyStarted) {
            ...
            // Inicie a animação apenas se não tiver sido iniciada antes
